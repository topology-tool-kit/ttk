/// \ingroup vtkWrappers
/// \class vtkScalarFieldNormalizer
...
#ifndef _VTK_SCALARFIELDNORMALIZER_H
#define _VTK_SCALARFIELDNORMALIZER_H
...
class VTKFILTERSCORE_EXPORT vtkScalarFieldNormalizer 
  : public vtkDataSetAlgorithm, public Wrapper{

  public:
      
    static vtkScalarFieldNormalizer* New();
    
    vtkTypeMacro(vtkScalarFieldNormalizer, vtkDataSetAlgorithm);
...
#endif // _VTK_SCALARFIELDNORMALIZER_H