...
#ifndef _VTK_EDITOR_BASE_H
#define _VTK_EDITOR_BASE_H
...
class vtkProgramBase : public ProgramBase{
...
template <class ttkModule> 
  class vtkProgram : public vtkProgramBase{
