...
#ifndef _VTK_UNCERTAINDATAESTIMATOR_H
#define _VTK_UNCERTAINDATAESTIMATOR_H
...
class VTKFILTERSCORE_EXPORT vtkUncertainDataEstimator
  : public vtkDataSetAlgorithm, public Wrapper{

  public:

    static vtkUncertainDataEstimator* New();

    vtkTypeMacro(vtkUncertainDataEstimator, vtkDataSetAlgorithm);
...
#endif // _VTK_UNCERTAINDATAESTIMATOR_H
