...
/// \sa vtkReebSpace
///
#ifndef _VTK_RANGEPOLYGON_H
#define _VTK_RANGEPOLYGON_H
...
class VTKFILTERSCORE_EXPORT vtkRangePolygon 
  : public vtkDataSetAlgorithm, public Wrapper{

  public:
      
    static vtkRangePolygon* New();
    
    vtkTypeMacro(vtkRangePolygon, vtkDataSetAlgorithm);
