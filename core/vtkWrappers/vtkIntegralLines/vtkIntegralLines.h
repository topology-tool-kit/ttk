...
#ifndef _VTK_DISCRETESTREAMLINE_H
#define _VTK_DISCRETESTREAMLINE_H
...
class VTKFILTERSCORE_EXPORT vtkIntegralLines
: public vtkDataSetAlgorithm, public Wrapper{

  public:

    static vtkIntegralLines* New();

    vtkTypeMacro(vtkIntegralLines, vtkDataSetAlgorithm);
...
#endif // _VTK_DISCRETESTREAMLINE_H
