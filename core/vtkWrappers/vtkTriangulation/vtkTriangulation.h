...
/// \date January 2016.
/// 
/// \brief vtkTriangulation is a wrapper for the ttk::Triangulation class, which
...
class vtkTriangulation : public Debug{
  ...
  public:
    ...
    /// the VTK data-set has undergone a vtkTriangulationFilter (i.e. if it
    /// is the direct output of a vtkTriangulationFilter or if a
    /// vtkTriangulationFilter has been called in an earlier stage of the 
    /// pipeline).
...
// Internal things to allow the vtkTriangulation to travel through a VTK 
// pipeline.
