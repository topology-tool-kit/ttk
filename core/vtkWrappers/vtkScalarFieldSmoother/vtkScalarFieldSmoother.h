...
#ifndef _VTK_SCALAR_FIELD_SMOOTHER_H
#define _VTK_SCALAR_FIELD_SMOOTHER_H
...
class VTKFILTERSCORE_EXPORT vtkScalarFieldSmoother 
  : public vtkDataSetAlgorithm, public Wrapper{

  public:
      
    static vtkScalarFieldSmoother* New();
    
    vtkTypeMacro(vtkScalarFieldSmoother, vtkDataSetAlgorithm);
...
#endif // _VTK_SCALAR_FIELD_SMOOTHER_H