...
///
#ifndef _VTK_TEXTURE_MAP_FROM_FIELD_H
#define _VTK_TEXTURE_MAP_FROM_FIELD_H
...
class VTKFILTERSCORE_EXPORT vtkTextureMapFromField 
  : public vtkDataSetAlgorithm, public Wrapper{

  public:
      
    static vtkTextureMapFromField* New();
    
    vtkTypeMacro(vtkTextureMapFromField, vtkDataSetAlgorithm);
...
#endif // _VTK_TEXTURE_MAP_FROM_FIELD_H