/// \ingroup vtkWrappers
/// \class vtkTopologicalSimplification
...
#ifndef _VTK_TOPOLOGICALSIMPLIFICATION_H
#define _VTK_TOPOLOGICALSIMPLIFICATION_H
...
class VTKFILTERSCORE_EXPORT vtkTopologicalSimplification
: public vtkDataSetAlgorithm, public Wrapper{

  public:
    
    static vtkTopologicalSimplification* New();
    vtkTypeMacro(vtkTopologicalSimplification, vtkDataSetAlgorithm);
...
#endif // _VTK_TOPOLOGICALSIMPLIFICATION_H
