...
#ifndef _VTK_CELLDATACONVERTER_H
#define _VTK_CELLDATACONVERTER_H
...
class VTKFILTERSCORE_EXPORT vtkCellDataConverter 
...
Double=0,
  ...
  public:      
    static vtkCellDataConverter* New();
    
    vtkTypeMacro(vtkCellDataConverter, vtkDataSetAlgorithm);
...
#endif // _VTK_CELLDATACONVERTER_H
