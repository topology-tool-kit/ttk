...
/// \date The Date Here.
///
/// \brief TTK VTK-filter that wraps the persistenceDiagramsBarycenter processing package.
///
/// VTK wrapping code for the @PersistenceDiagramsBarycenter package.
/// 
...
//       SetNumberOfOutputPorts(2);
  ...
  private:
    ...
    ttk::PersistenceDiagramsBarycenter            persistenceDiagramsBarycenter_;
