...
/// IEEE 10th Symposium on Large Data Analysis and Visualization (LDAV),
/// 2020.
///
/// \sa ttkAlgorithm
...
protected:
  ...
  /// Replaces all palceholder strings of the input string based on previously added replacements.
