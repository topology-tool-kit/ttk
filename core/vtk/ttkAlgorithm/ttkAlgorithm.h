...
///
/// This is an abstract vtkAlgorithm that provides standardized input/output managment for VTK wrappers of ttk filters. The class also provides a static method to retrieve a ttk::Triangulation of a vtkDataSet.
...
class TTKALGORITHM_EXPORT ttkAlgorithm
  : public vtkAlgorithm
  , virtual public ttk::Debug
{
    private:
        static std::unordered_map<void*, std::pair<ttk::Triangulation*,vtkMTimeType>> DataSetToTriangulationMap;
    ...
    public:
        ...
        /**
        * Controls the maximum number of threads used by algorithms that are invoked by the VTK wrapper.
        */
    ...
    protected:
        ...
        * In general it should not be necessary to override this method.
        */
        virtual int RequestDataNotGenerated(
            vtkInformation*        request,
            vtkInformationVector** inputVectors,
            vtkInformationVector*  outputVector
        ){
