...
vtkSmartPointer<vtkUnstructuredGrid>
  ttkPersistenceDiagramDistanceMatrix::createOutputCentroids() {
  if(debugLevel_ > 5) {
    std::cout << "[ttkPersistenceDiagramDistanceMatrix] Creating vtk diagrams"
              << std::endl;
  }
...
vtkSmartPointer<vtkUnstructuredGrid>
  ttkPersistenceDiagramDistanceMatrix::createOutputClusteredDiagrams() {
  if(debugLevel_ > 5) {
    std::cout << "[ttkPersistenceDiagramDistanceMatrix] Creating vtk Outputs"
              << std::endl;
  }
  vtkNew<vtkPoints> points{};
...
vtkSmartPointer<vtkUnstructuredGrid>
  ttkPersistenceDiagramDistanceMatrix::createMatchings() {
  if(debugLevel_ > 5) {
    std::cout << "[ttkPersistenceDiagramDistanceMatrix] Creating vtk Matchings"
              << std::endl;
  }
