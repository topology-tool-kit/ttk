...
/// \date The Date Here.
///
/// \brief TTK VTK-filter that wraps the ttk::BettiNumbers module.
///
/// This VTK filter uses the ttk::BettiNumbers module to compute an averaging of
...
///   - standalone/BettiNumbers/main.cpp
///
...
// VTK Module
#include <ttkBettiNumbersModule.h>
...
class TTKBETTINUMBERS_EXPORT ttkBettiNumbers
  : public ttkAlgorithm // we inherit from the generic ttkAlgorithm class
  ,
    protected ttk::BettiNumbers // and we inherit from the base class
{
private:
  /**
...
public:
  ...
  vtkTypeMacro(ttkBettiNumbers, ttkAlgorithm);
...
protected:
   ...
   */
  ttkBettiNumbers();
  ~ttkBettiNumbers() override = default;
