...
#define macroDiagramTuple std::tuple<ttk::SimplexId, ttk::CriticalType, ttk::SimplexId, ttk::CriticalType, VTK_TT, ttk::SimplexId, VTK_TT, float, float, float, VTK_TT, float, float, float>
#endif
...
int ttkPersistenceDiagramsClustering::updateProgress(const float &progress)
{
    {
        stringstream msg;
        msg << "[ttkPersistenceDiagramsClustering] " << progress * 100 << "% processed...." << endl;
...
int ttkPersistenceDiagramsClustering::RequestData(vtkInformation *request, vtkInformationVector **inputVector, vtkInformationVector *outputVector)
{
    Memory m;
    ...
    {
        stringstream msg;
        msg << "[ttkPersistenceDiagramsClustering] Memory usage: " << m.getElapsedUsage() << " MB." << endl;
