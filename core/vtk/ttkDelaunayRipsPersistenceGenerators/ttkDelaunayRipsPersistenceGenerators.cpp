...
int ttkDelaunayRipsPersistenceGenerators::FillOutputPortInformation(int port,
                                                         vtkInformation *info) {
...
int ttkDelaunayRipsPersistenceGenerators::RequestData(vtkInformation *ttkNotUsed(request),
