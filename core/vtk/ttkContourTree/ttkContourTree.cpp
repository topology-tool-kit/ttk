...
int ttkContourTree::addCompleteSkeletonArc(const ttk::ftm::idSuperArc arcId,
                                           const int cc,
                                           vtkPoints *points,
                                           vtkUnstructuredGrid *skeletonArcs,
                                           ttk::ftm::ArcData &arcData) {
  auto tree = ftmTree_[cc].tree.getTree(ttk::ftm::TreeType::Contour);
...
int ttkContourTree::addDirectSkeletonArc(const ttk::ftm::idSuperArc arcId,
                                         const int cc,
                                         vtkPoints *points,
                                         vtkUnstructuredGrid *skeletonArcs,
                                         ttk::ftm::ArcData &arcData) {
...
int ttkContourTree::addSampledSkeletonArc(const ttk::ftm::idSuperArc arcId,
                                          const int cc,
                                          vtkPoints *points,
                                          vtkUnstructuredGrid *skeletonArcs,
                                          ttk::ftm::ArcData &arcData) {
...
int ttkContourTree::getSegmentation(vtkDataSet *outputSegmentation) {
...
int ttkContourTree::getSkeletonArcs(vtkUnstructuredGrid *outputSkeletonArcs) {
...
int ttkContourTree::getSkeletonNodes(vtkUnstructuredGrid *outputSkeletonNodes) {
...
#ifdef TTK_ENABLE_FTM_TREE_STATS_TIME
void ttkContourTree::printCSVStats() {
  using namespace ttk;

  for(auto &t : ftmTree_) {
    switch(ttk::ftm::TreeType::Contour) {
...
void ttkContourTree::printCSVTree(
...
void ttkContourTree::identify(vtkDataSet *ds) const {
