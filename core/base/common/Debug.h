  ...
  class Debug : virtual public BaseClass {
    ...
    public:
      ...
      inline int PrintMsg(
        ...
        if((this->debugLevel_ < priorityAsInt) && (globalDebugLevel_ < priorityAsInt))
            return 0;
      ...
      inline int PrintErr(
        ...
        return this->PrintMsgInternal(msg, DEBUG::PRIORITY::ERROR, lineMode, stream);
      }
      ...
      inline int PrintMsg(
        ...
        return this->PrintMsgInternal(msg, stats, msg.length()<1 ? ">" : ".", priority, lineMode, stream);
      }
      ...
      inline int PrintMsg(
        ...
        return this->PrintMsg(msg, progress, time, -1, lineMode, priority, stream);
      }
      ...
      inline int PrintMsg(
        ...
        auto formatCell = [](const std::string& value, const size_t& width, const std::string& fillSymbol=" "){
    ...
    protected:
      ...
      inline int PrintMsgInternal(
        ...
        if(filler.length()>0){
          int gapWidth = DEBUG::LINEWIDTH - this->DebugMsgPrefix.length() - combinedMsg.length() - right.length();
