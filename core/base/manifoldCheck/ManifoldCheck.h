...
namespace ttk{
  ...
  class ManifoldCheck : public Debug{
    ...
    public:
      ...
      /// see the setInput*() functions of ttk::Triangulation). See vtkManifoldCheck 
...
// #include                  <ManifoldCheck.cpp>

// template functions
template <class dataType> int ManifoldCheck::execute(
