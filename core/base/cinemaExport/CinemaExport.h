/// \ingroup base
/// \class ttk::CinemaExport 
/// \author Your Name Here <Your Email Address Here>
/// \date The Date Here.
///
/// \brief TTK %cinemaExport processing package.
///
/// %CinemaExport is a TTK processing package that takes a scalar field on the input 
/// and produces a scalar field on the output.
///
/// \sa ttk::Triangulation
/// \sa ttkCinemaExport.cpp %for a usage example.
...
namespace ttk{
  ...
  class CinemaExport : public Debug{
    ...
    public:
      ...
      /// see the setInput*() functions of ttk::Triangulation). See ttkCinemaExport 
...
// #include                  <CinemaExport.cpp>

// template functions
template <class dataType> int ttk::CinemaExport::execute(
...
#pragma omp parallel for num_threads(threadNumber_) 
   ...
   
  {
    ...
    msg << "[CinemaExport] Data-set (" << vertexNumber
      << " points) processed in "
