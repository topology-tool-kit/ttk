...
index[2]][k];
    ...
    // class 1
      ...
      double massDensity{};
      double p[3]{0,0,0};
      if(Geometry::computeSegmentIntersection(data[0][0],data[0][1],
            data[1][0],data[1][1],
            data[2][0],data[2][1],
            data[3][0],data[3][1],
            p[0],p[1])){
      ...
      else if(Geometry::computeSegmentIntersection(data[0][0],data[0][1],
            data[2][0],data[2][1],
            data[1][0],data[1][1],
            data[3][0],data[3][1],
            p[0],p[1])){
...
o[3]{scalarMin_[0]+i*sampling[0],scalarMin_[1]+j*sampling[1],1};
          for(unsigned int k=0; k<triangles.size(); ++k){
            ...
            const double 
p1[3]{(double)scalars1[tr[1]],(double)scalars2[tr[1]],0};
            const double 
p2[3]{(double)scalars1[tr[2]],(double)scalars2[tr[2]],0};
            ...
            if(a>-epsilon and a<epsilon) continue;
