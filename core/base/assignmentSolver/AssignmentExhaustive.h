...
namespace ttk {
  ...
  public:
    ...
    void constructAssignments3(unsigned int min_dim,
  ...
  int AssignmentExhaustive<dataType>::run(
    ...
    // These assignments are automatically generated by constructAssignments
    if(min_dim == 1 and max_dim == 1)
      ...
      if(not saveAsgn or savedAsgn.find(asgnName) == savedAsgn.end()) {
        ...
        constructAssignments3(min_dim, max_dim, allAsgn);
        if(saveAsgn) {
