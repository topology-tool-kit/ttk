...
template <typename T>
int ttk::Laplacian::shortestPath(const ttk::SimplexId source,
...
template int
  ttk::Laplacian::shortestPath<float>(const ttk::SimplexId source,
                                     ttk::Triangulation &triangulation,
                                     std::vector<float> &outputDists,
                                     const std::vector<ttk::SimplexId> &bounds);
template int
  ttk::Laplacian::shortestPath<double>(const ttk::SimplexId source,
                                      ttk::Triangulation &triangulation,
