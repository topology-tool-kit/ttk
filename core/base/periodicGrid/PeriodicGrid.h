...
///
/// \ingroup base
/// \class ttk::PeriodicGrid
/// \author Your Name Here <Your Email Address Here>
/// \date The Date Here.
///
/// This module defines the %PeriodicGrid class that computes for each vertex of
...
namespace ttk {
  ...
  /**
   * The PeriodicGrid class provides methods to compute for each vertex of a
   * triangulation the average scalar value of itself and its direct neighbors.
   */
  class PeriodicGrid : virtual public Debug {

  public:
    PeriodicGrid() {
      this->setDebugMsgPrefix(
        "PeriodicGrid"); // inherited from Debug: prefix will be printed at the
