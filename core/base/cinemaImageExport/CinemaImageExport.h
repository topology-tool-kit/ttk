/// \ingroup base
/// \class ttk::CinemaImageExport 
/// \author Your Name Here <Your Email Address Here>
/// \date The Date Here.
///
/// \brief TTK %cinemaImageExport processing package.
///
/// %CinemaImageExport is a TTK processing package that takes a scalar field on the input 
/// and produces a scalar field on the output.
///
/// \sa ttk::Triangulation
/// \sa ttkCinemaImageExport.cpp %for a usage example.
...
namespace ttk{
  ...
  class CinemaImageExport : public Debug{
    ...
    public:
      ...
      /// see the setInput*() functions of ttk::Triangulation). See ttkCinemaImageExport 
...
// #include                  <CinemaImageExport.cpp>

// template functions
template <class dataType> int ttk::CinemaImageExport::execute(
...
#pragma omp parallel for num_threads(threadNumber_) 
   ...
   
  {
    ...
    msg << "[CinemaImageExport] Data-set (" << vertexNumber
      << " points) processed in "
