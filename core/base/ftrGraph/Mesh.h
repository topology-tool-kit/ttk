   ...
   namespace ftr
   {
      ...
      class Mesh : public Allocable
      {
         ...
         public:
          ...
          inline void getVertexNeighbor(const idVertex v, const idVertex local_v, idVertex & res)
          {
          ...
          inline void getVertexEdge(const idVertex v, const idEdge local_e, idEdge& res) const
          {
          ...
          inline void getVertexTriangle(const idVertex v, const idCell local_c, idCell& res) const
          {
             tri_->getVertexTriangle(v, local_c, res);
          }

          inline void getEdgeVertex(const idEdge e, const char local_id, idVertex& res) const
          {
          ...
          inline void getEdgeTriangle(const idEdge e, const idCell local_t, idCell& res) const
          {
          ...
          inline void getTriangleEdge(const idCell t, const char local_id, idEdge& res) const
          {
             tri_->getTriangleEdge(t, local_id, res);
          }

          // Extend Triangulation by pre-sorting scalars
          // This is done by keeping id of the internal scheme of the simplex to reorder it instantly
