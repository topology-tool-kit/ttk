...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexNeighbor2dA(const SimplexId v,
                                                           const int id) const {
  switch(id) {
    case 0:
      return v - 1 + wrap_[0];
    case 1:
      return v - vshift_[0] + wrap_[1];
    case 2:
      return v - vshift_[0] + 1 + wrap_[1];
    case 3:
      return v + 1;
    case 4:
      return v + vshift_[0];
    case 5:
      return v + vshift_[0] - 1 + wrap_[0];
  }
  return -1;
}

inline ttk::SimplexId ttk::PeriodicImplicitTriangulation::getVertexNeighbor2dAB(
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexNeighbor2dB(const SimplexId v,
                                                           const int id) const {
  switch(id) {
    case 0:
      return v - 1;
    case 1:
      return v - vshift_[0] + wrap_[1];
    case 2:
      return v - vshift_[0] + 1 - wrap_[0] + wrap_[1];
    case 3:
      return v + 1 - wrap_[0];
    case 4:
      return v + vshift_[0];
...
inline ttk::SimplexId ttk::PeriodicImplicitTriangulation::getVertexNeighbor2dAC(
  const SimplexId v, const int id) const {
  switch(id) {
    case 0:
      return v - 1 + wrap_[0];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexNeighbor2dABCD(
    const SimplexId v, const int id) const {
  switch(id) {
    case 0:
      return v - 1;
...
inline ttk::SimplexId ttk::PeriodicImplicitTriangulation::getVertexNeighbor2dBD(
  const SimplexId v, const int id) const {
  switch(id) {
    case 0:
      return v - 1;
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexNeighbor2dC(const SimplexId v,
                                                           const int id) const {
  switch(id) {
    case 0:
      return v - 1 + wrap_[0];
...
inline ttk::SimplexId ttk::PeriodicImplicitTriangulation::getVertexNeighbor2dCD(
  const SimplexId v, const int id) const {
  switch(id) {
    case 0:
      return v - 1;
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexNeighbor2dD(const SimplexId v,
                                                           const int id) const {
  switch(id) {
    case 0:
      return v - 1;
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexEdge2dA(const SimplexId p[2],
                                                       const int id) const {
  switch(id) {
    case 0:
      return esetshift_[0] + p[0] + (p[1] - 1) * eshift_[2] + wrap_[1];
    case 1:
      return p[0] + p[1] * eshift_[0] - 1 + wrap_[0];
    case 2:
      return esetshift_[1] + p[0] + (p[1] - 1) * eshift_[4] + wrap_[1];
    case 3:
      return p[0] + p[1] * eshift_[0];
    case 4:
      return esetshift_[0] + p[0] + p[1] * eshift_[2];
    case 5:
      return esetshift_[1] + p[0] + p[1] * eshift_[4] - 1 + wrap_[0];
  }
  return -1;
}

inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexEdge2dAB(const SimplexId p[2],
                                                        const int id) const {
  switch(id) {
    case 0:
      return esetshift_[0] + p[0] + (p[1] - 1) * eshift_[2] + wrap_[1];
    case 1:
      return p[0] + p[1] * eshift_[0] - 1;
    case 2:
      return esetshift_[1] + p[0] + (p[1] - 1) * eshift_[4] + wrap_[1];
    case 3:
      return p[0] + p[1] * eshift_[0];
    case 4:
      return esetshift_[0] + p[0] + p[1] * eshift_[2];
    case 5:
      return esetshift_[1] + p[0] + p[1] * eshift_[4] - 1;
  }
  return -1;
}

inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexEdge2dB(const SimplexId p[2],
                                                       const int id) const {
  switch(id) {
    case 0:
      return esetshift_[0] + p[0] + (p[1] - 1) * eshift_[2] + wrap_[1];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexEdge2dAC(const SimplexId p[2],
                                                        const int id) const {
  switch(id) {
    case 0:
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexEdge2dABCD(const SimplexId p[2],
                                                          const int id) const {
  switch(id) {
    case 0:
      return esetshift_[0] + p[0] + (p[1] - 1) * eshift_[2];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexEdge2dBD(const SimplexId p[2],
                                                        const int id) const {
  switch(id) {
    case 0:
      return esetshift_[0] + p[0] + (p[1] - 1) * eshift_[2];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexEdge2dC(const SimplexId p[2],
                                                       const int id) const {
  switch(id) {
    case 0:
      return esetshift_[0] + p[0] + (p[1] - 1) * eshift_[2];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexEdge2dCD(const SimplexId p[2],
                                                        const int id) const {
  switch(id) {
    case 0:
      return esetshift_[0] + p[0] + (p[1] - 1) * eshift_[2];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexEdge2dD(const SimplexId p[2],
                                                       const int id) const {
  switch(id) {
    case 0:
      return esetshift_[0] + p[0] + (p[1] - 1) * eshift_[2];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexStar2dA(const SimplexId p[2],
                                                       const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 2 + p[1] * tshift_[0] + 2 * wrap_[0];
    case 1:
      return (p[0] - 1) * 2 + p[1] * tshift_[0] + 1 + 2 * wrap_[0];
    case 2:
      return p[0] * 2 + p[1] * tshift_[0];
    case 3:
      return p[0] * 2 + (p[1] - 1) * tshift_[0] + 2 * wrap_[1];
    case 4:
      return p[0] * 2 + (p[1] - 1) * tshift_[0] + 1 + 2 * wrap_[1];
    case 5:
      return (p[0] - 1) * 2 + (p[1] - 1) * tshift_[0] + 1 + 2 * wrap_[0]
             + 2 * wrap_[1];
  }
  return -1;
}
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexStar2dAB(const SimplexId p[2],
                                                        const int id) const {
  switch(id) {
    case 0:
    ...
    case 4:
      return p[0] * 2 + (p[1] - 1) * tshift_[0] + 1 + 2 * wrap_[1];
    case 5:
      return (p[0] - 1) * 2 + (p[1] - 1) * tshift_[0] + 1 + 2 * wrap_[1];
  }
  return -1;
}

inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexStar2dB(const SimplexId p[2],
                                                       const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 2 + p[1] * tshift_[0];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexStar2dAC(const SimplexId p[2],
                                                        const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 2 + p[1] * tshift_[0] + 2 * wrap_[0];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexStar2dABCD(const SimplexId p[2],
                                                          const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 2 + p[1] * tshift_[0];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexStar2dBD(const SimplexId p[2],
                                                        const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 2 + p[1] * tshift_[0];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexStar2dC(const SimplexId p[2],
                                                       const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 2 + p[1] * tshift_[0] + 2 * wrap_[0];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexStar2dCD(const SimplexId p[2],
                                                        const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 2 + p[1] * tshift_[0];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexStar2dD(const SimplexId p[2],
                                                       const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 2 + p[1] * tshift_[0];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexLink2dA(const SimplexId p[2],
                                                       const int id) const {
  switch(id) {
    case 0:
      return esetshift_[0] + p[0] + p[1] * eshift_[2] - 1 + wrap_[0];
    case 1:
      return p[0] + (p[1] + 1) * eshift_[0] - 1 + wrap_[0];
    case 2:
      return esetshift_[1] + p[0] + p[1] * eshift_[4];
    case 3:
      return esetshift_[0] + p[0] + (p[1] - 1) * eshift_[2] + 1 + wrap_[1];
    case 4:
      return p[0] + (p[1] - 1) * eshift_[0] + wrap_[1];
    case 5:
      return esetshift_[1] + p[0] + (p[1] - 1) * eshift_[4] - 1 + wrap_[0]
             + wrap_[1];
  }
  return -1;
}
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexLink2dAB(const SimplexId p[2],
                                                        const int id) const {
  switch(id) {
    case 0:
      return esetshift_[0] + p[0] + p[1] * eshift_[2] - 1;
    case 1:
      return p[0] + (p[1] + 1) * eshift_[0] - 1;
    case 2:
      return esetshift_[1] + p[0] + p[1] * eshift_[4];
    case 3:
      return esetshift_[0] + p[0] + (p[1] - 1) * eshift_[2] + 1 + wrap_[1];
    case 4:
      return p[0] + (p[1] - 1) * eshift_[0] + wrap_[1];
    case 5:
      return esetshift_[1] + p[0] + (p[1] - 1) * eshift_[4] - 1 + wrap_[1];
  }
  return -1;
}

inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexLink2dB(const SimplexId p[2],
                                                       const int id) const {
  switch(id) {
    case 0:
      return esetshift_[0] + p[0] + p[1] * eshift_[2] - 1;
    ...
    case 2:
      return esetshift_[1] + p[0] + p[1] * eshift_[4];
    case 3:
      return esetshift_[0] + p[0] + (p[1] - 1) * eshift_[2] + 1 - wrap_[0]
             + wrap_[1];
    case 4:
      return p[0] + (p[1] - 1) * eshift_[0] + wrap_[1];
    case 5:
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexLink2dAC(const SimplexId p[2],
                                                        const int id) const {
  switch(id) {
    case 0:
      return esetshift_[0] + p[0] + p[1] * eshift_[2] - 1 + wrap_[0];
    ...
    case 2:
      return esetshift_[1] + p[0] + p[1] * eshift_[4];
    case 3:
      return esetshift_[0] + p[0] + (p[1] - 1) * eshift_[2] + 1;
    case 4:
      return p[0] + (p[1] - 1) * eshift_[0];
    case 5:
      return esetshift_[1] + p[0] + (p[1] - 1) * eshift_[4] - 1 + wrap_[0];
  }
  return -1;
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexLink2dABCD(const SimplexId p[2],
                                                          const int id) const {
  switch(id) {
    case 0:
      return esetshift_[0] + p[0] + p[1] * eshift_[2] - 1;
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexLink2dBD(const SimplexId p[2],
                                                        const int id) const {
  switch(id) {
    case 0:
      return esetshift_[0] + p[0] + p[1] * eshift_[2] - 1;
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexLink2dC(const SimplexId p[2],
                                                       const int id) const {
  switch(id) {
    case 0:
      return esetshift_[0] + p[0] + p[1] * eshift_[2] - 1 + wrap_[0];
    case 1:
      return p[0] + (p[1] + 1) * eshift_[0] - 1 + wrap_[0] - wrap_[1];
    case 2:
      return esetshift_[1] + p[0] + p[1] * eshift_[4];
    case 3:
      return esetshift_[0] + p[0] + (p[1] - 1) * eshift_[2] + 1;
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexLink2dCD(const SimplexId p[2],
                                                        const int id) const {
  switch(id) {
    case 0:
      return esetshift_[0] + p[0] + p[1] * eshift_[2] - 1;
    case 1:
      return p[0] + (p[1] + 1) * eshift_[0] - 1 - wrap_[1];
    case 2:
      return esetshift_[1] + p[0] + p[1] * eshift_[4];
    case 3:
      return esetshift_[0] + p[0] + (p[1] - 1) * eshift_[2] + 1;
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexLink2dD(const SimplexId p[2],
                                                       const int id) const {
  switch(id) {
    case 0:
      return esetshift_[0] + p[0] + p[1] * eshift_[2] - 1;
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getEdgeTriangleL_x0(const SimplexId p[3],
                                                          const int id) const {
  switch(id) {
    case 0:
      return p[Di_] * 2 + p[Dj_] * tshift_[0];
    case 1:
      return p[Di_] * 2 + (p[Dj_] - 1) * tshift_[0] + 1 + 2 * wrap_[1];
  }
  return -1;
}

inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getEdgeTriangleL_xn(const SimplexId p[3],
                                                          const int id) const {
  switch(id) {
    case 0:
      return p[Di_] * 2 + p[Dj_] * tshift_[0];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getEdgeTriangleH_0y(const SimplexId p[3],
                                                          const int id) const {
  switch(id) {
    case 0:
      return p[Di_] * 2 + p[Dj_] * tshift_[0];
    case 1:
      return (p[Di_] - 1) * 2 + p[Dj_] * tshift_[0] + 1 + 2 * wrap_[0];
  }
  return -1;
}

inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getEdgeTriangleH_ny(const SimplexId p[3],
                                                          const int id) const {
  switch(id) {
    case 0:
      return p[Di_] * 2 + p[Dj_] * tshift_[0];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getEdgeTriangleD1_xy(const SimplexId p[3],
                                                           const int id) const {
  switch(id) {
    case 0:
      return p[Di_] * 2 + p[Dj_] * tshift_[0];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexNeighborA(const SimplexId v,
                                                         const int id) const {
  switch(id) {
    case 0:
      return v - vshift_[0] - vshift_[1] + wrap_[1] + wrap_[2];
    case 1:
      return v + 1 - vshift_[0] - vshift_[1] + wrap_[1] + wrap_[2];
    case 2:
      return v - vshift_[1] + wrap_[2];
    case 3:
      return v + 1 - vshift_[1] + wrap_[2];
    case 4:
      return v - vshift_[0] + wrap_[1];
    case 5:
      return v + 1 - vshift_[0] + wrap_[1];
    case 6:
      return v + 1;
    case 7:
      return v - 1 + vshift_[1] + wrap_[0];
    case 8:
      return v + vshift_[1];
    case 9:
      return v - 1 + wrap_[0];
    case 10:
      return v - 1 + vshift_[0] + wrap_[0];
    case 11:
      return v + vshift_[0];
    case 12:
      return v - 1 + vshift_[0] + vshift_[1] + wrap_[0];
    case 13:
      return v + vshift_[0] + vshift_[1];
  }
  return -1;
}

inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexNeighborAB(const SimplexId v,
                                                          const int id) const {
  switch(id) {
    case 0:
      return v - vshift_[0] - vshift_[1] + wrap_[1] + wrap_[2];
    ...
    case 6:
      return v + 1;
    case 7:
      return v - 1 + vshift_[1];
    case 8:
      return v + vshift_[1];
    case 9:
      return v - 1;
    case 10:
      return v - 1 + vshift_[0];
    case 11:
      return v + vshift_[0];
    case 12:
      return v - 1 + vshift_[0] + vshift_[1];
    case 13:
      return v + vshift_[0] + vshift_[1];
  }
  return -1;
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexNeighborB(const SimplexId v,
                                                         const int id) const {
  switch(id) {
    case 0:
      return v - vshift_[0] - vshift_[1] + wrap_[1] + wrap_[2];
    case 1:
      return v + 1 - vshift_[0] - vshift_[1] - wrap_[0] + wrap_[1] + wrap_[2];
    case 2:
      return v - vshift_[1] + wrap_[2];
    case 3:
      return v + 1 - vshift_[1] - wrap_[0] + wrap_[2];
    case 4:
      return v - vshift_[0] + wrap_[1];
    case 5:
      return v + 1 - vshift_[0] - wrap_[0] + wrap_[1];
    case 6:
      return v + 1 - wrap_[0];
    case 7:
      return v - 1 + vshift_[1];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexNeighborAC(const SimplexId v,
                                                          const int id) const {
  switch(id) {
    case 0:
      return v - vshift_[0] - vshift_[1] + wrap_[2];
    case 1:
      return v + 1 - vshift_[0] - vshift_[1] + wrap_[2];
    case 2:
      return v - vshift_[1] + wrap_[2];
    case 3:
      return v + 1 - vshift_[1] + wrap_[2];
...
inline ttk::SimplexId ttk::PeriodicImplicitTriangulation::getVertexNeighborABDC(
  const SimplexId v, const int id) const {
  switch(id) {
    case 0:
      return v - vshift_[0] - vshift_[1] + wrap_[2];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexNeighborBD(const SimplexId v,
                                                          const int id) const {
  switch(id) {
    case 0:
      return v - vshift_[0] - vshift_[1] + wrap_[2];
    case 1:
      return v + 1 - vshift_[0] - vshift_[1] - wrap_[0] + wrap_[2];
    case 2:
      return v - vshift_[1] + wrap_[2];
    case 3:
      return v + 1 - vshift_[1] - wrap_[0] + wrap_[2];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexNeighborC(const SimplexId v,
                                                         const int id) const {
  switch(id) {
    case 0:
      return v - vshift_[0] - vshift_[1] + wrap_[2];
    ...
    case 11:
      return v + vshift_[0] - wrap_[1];
    case 12:
      return v - 1 + vshift_[0] + vshift_[1] + wrap_[0] - wrap_[1];
    case 13:
      return v + vshift_[0] + vshift_[1] - wrap_[1];
  }
  return -1;
}

inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexNeighborCD(const SimplexId v,
                                                          const int id) const {
  switch(id) {
    case 0:
      return v - vshift_[0] - vshift_[1] + wrap_[2];
    ...
    case 11:
      return v + vshift_[0] - wrap_[1];
    case 12:
      return v - 1 + vshift_[0] + vshift_[1] - wrap_[1];
    case 13:
      return v + vshift_[0] + vshift_[1] - wrap_[1];
  }
  return -1;
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexNeighborD(const SimplexId v,
                                                         const int id) const {
  switch(id) {
    case 0:
      return v - vshift_[0] - vshift_[1] + wrap_[2];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexNeighborAE(const SimplexId v,
                                                          const int id) const {
  switch(id) {
    case 0:
      return v - vshift_[0] - vshift_[1] + wrap_[1];
...
inline ttk::SimplexId ttk::PeriodicImplicitTriangulation::getVertexNeighborAEFB(
  const SimplexId v, const int id) const {
  switch(id) {
    case 0:
      return v - vshift_[0] - vshift_[1] + wrap_[1];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexNeighborBF(const SimplexId v,
                                                          const int id) const {
  switch(id) {
    case 0:
      return v - vshift_[0] - vshift_[1] + wrap_[1];
...
inline ttk::SimplexId ttk::PeriodicImplicitTriangulation::getVertexNeighborAEGC(
  const SimplexId v, const int id) const {
  switch(id) {
    case 0:
      return v - vshift_[0] - vshift_[1];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexNeighborABCDEFGH(
    const SimplexId v, const int id) const {
  switch(id) {
    case 0:
      return v - vshift_[0] - vshift_[1];
...
inline ttk::SimplexId ttk::PeriodicImplicitTriangulation::getVertexNeighborBFHD(
  const SimplexId v, const int id) const {
  switch(id) {
    case 0:
      return v - vshift_[0] - vshift_[1];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexNeighborCG(const SimplexId v,
                                                          const int id) const {
  switch(id) {
    case 0:
      return v - vshift_[0] - vshift_[1];
...
inline ttk::SimplexId ttk::PeriodicImplicitTriangulation::getVertexNeighborGHDC(
  const SimplexId v, const int id) const {
  switch(id) {
    case 0:
      return v - vshift_[0] - vshift_[1];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexNeighborDH(const SimplexId v,
                                                          const int id) const {
  switch(id) {
    case 0:
      return v - vshift_[0] - vshift_[1];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexNeighborE(const SimplexId v,
                                                         const int id) const {
  switch(id) {
    case 0:
      return v - vshift_[0] - vshift_[1] + wrap_[1];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexNeighborEF(const SimplexId v,
                                                          const int id) const {
  switch(id) {
    case 0:
      return v - vshift_[0] - vshift_[1] + wrap_[1];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexNeighborF(const SimplexId v,
                                                         const int id) const {
  switch(id) {
    case 0:
      return v - vshift_[0] - vshift_[1] + wrap_[1];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexNeighborEG(const SimplexId v,
                                                          const int id) const {
  switch(id) {
    case 0:
      return v - vshift_[0] - vshift_[1];
...
inline ttk::SimplexId ttk::PeriodicImplicitTriangulation::getVertexNeighborEFHG(
  const SimplexId v, const int id) const {
  switch(id) {
    case 0:
      return v - vshift_[0] - vshift_[1];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexNeighborFH(const SimplexId v,
                                                          const int id) const {
  switch(id) {
    case 0:
      return v - vshift_[0] - vshift_[1];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexNeighborG(const SimplexId v,
                                                         const int id) const {
  switch(id) {
    case 0:
      return v - vshift_[0] - vshift_[1];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexNeighborGH(const SimplexId v,
                                                          const int id) const {
  switch(id) {
    case 0:
      return v - vshift_[0] - vshift_[1];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexNeighborH(const SimplexId v,
                                                         const int id) const {
  switch(id) {
    case 0:
      return v - vshift_[0] - vshift_[1];
...
inline ttk::SimplexId
  ...
  switch(id) {
    ...
    case 9:
      return p[0] + p[1] * eshift_[0] + p[2] * eshift_[1] - 1 + wrap_[0];
    case 10:
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexEdgeAB(const SimplexId p[3],
                                                      const int id) const {
  switch(id) {
    case 0:
      return esetshift_[3] + p[0] + (p[1] - 1) * eshift_[8]
    ...
    case 8:
      return esetshift_[1] + p[0] + p[1] * eshift_[4] + p[2] * eshift_[5];
    case 9:
      return p[0] + p[1] * eshift_[0] + p[2] * eshift_[1] - 1;
    case 10:
      return esetshift_[2] + p[0] + p[1] * eshift_[6] + p[2] * eshift_[7] - 1;
    case 11:
      return esetshift_[0] + p[0] + p[1] * eshift_[2] + p[2] * eshift_[3];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexEdgeB(const SimplexId p[3],
                                                     const int id) const {
  switch(id) {
    case 0:
      return esetshift_[3] + p[0] + (p[1] - 1) * eshift_[8]
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexEdgeAC(const SimplexId p[3],
                                                      const int id) const {
  switch(id) {
    case 0:
      return esetshift_[3] + p[0] + (p[1] - 1) * eshift_[8]
             + (p[2] - 1) * eshift_[9] + wrap_[2];
    case 1:
      return esetshift_[5] + p[0] + (p[1] - 1) * eshift_[12]
             + (p[2] - 1) * eshift_[13] + wrap_[2];
    case 2:
      return esetshift_[1] + p[0] + p[1] * eshift_[4] + (p[2] - 1) * eshift_[5]
             + wrap_[2];
    case 3:
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexEdgeABDC(const SimplexId p[3],
                                                        const int id) const {
  switch(id) {
    case 0:
      return esetshift_[3] + p[0] + (p[1] - 1) * eshift_[8]
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexEdgeBD(const SimplexId p[3],
                                                      const int id) const {
  switch(id) {
    case 0:
      return esetshift_[3] + p[0] + (p[1] - 1) * eshift_[8]
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexEdgeC(const SimplexId p[3],
                                                     const int id) const {
  switch(id) {
    case 0:
      return esetshift_[3] + p[0] + (p[1] - 1) * eshift_[8]
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexEdgeCD(const SimplexId p[3],
                                                      const int id) const {
  switch(id) {
    case 0:
      return esetshift_[3] + p[0] + (p[1] - 1) * eshift_[8]
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexEdgeD(const SimplexId p[3],
                                                     const int id) const {
  switch(id) {
    case 0:
      return esetshift_[3] + p[0] + (p[1] - 1) * eshift_[8]
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexEdgeAE(const SimplexId p[3],
                                                      const int id) const {
  switch(id) {
    case 0:
      return esetshift_[3] + p[0] + (p[1] - 1) * eshift_[8]
             + (p[2] - 1) * eshift_[9] + wrap_[1];
    case 1:
      return esetshift_[5] + p[0] + (p[1] - 1) * eshift_[12]
             + (p[2] - 1) * eshift_[13] + wrap_[1];
    case 2:
      return esetshift_[1] + p[0] + p[1] * eshift_[4] + (p[2] - 1) * eshift_[5];
    case 3:
      return esetshift_[4] + p[0] + p[1] * eshift_[10]
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexEdgeAEFB(const SimplexId p[3],
                                                        const int id) const {
  switch(id) {
    case 0:
      return esetshift_[3] + p[0] + (p[1] - 1) * eshift_[8]
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexEdgeBF(const SimplexId p[3],
                                                      const int id) const {
  switch(id) {
    case 0:
      return esetshift_[3] + p[0] + (p[1] - 1) * eshift_[8]
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexEdgeAEGC(const SimplexId p[3],
                                                        const int id) const {
  switch(id) {
    case 0:
      return esetshift_[3] + p[0] + (p[1] - 1) * eshift_[8]
...
inline ttk::SimplexId ttk::PeriodicImplicitTriangulation::getVertexEdgeABCDEFGH(
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexEdgeBFHD(const SimplexId p[3],
                                                        const int id) const {
  switch(id) {
    case 0:
      return esetshift_[3] + p[0] + (p[1] - 1) * eshift_[8]
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexEdgeCG(const SimplexId p[3],
                                                      const int id) const {
  switch(id) {
    case 0:
      return esetshift_[3] + p[0] + (p[1] - 1) * eshift_[8]
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexEdgeGHDC(const SimplexId p[3],
                                                        const int id) const {
  switch(id) {
    case 0:
      return esetshift_[3] + p[0] + (p[1] - 1) * eshift_[8]
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexEdgeDH(const SimplexId p[3],
                                                      const int id) const {
  switch(id) {
    case 0:
      return esetshift_[3] + p[0] + (p[1] - 1) * eshift_[8]
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexEdgeE(const SimplexId p[3],
                                                     const int id) const {
  switch(id) {
    case 0:
      return esetshift_[3] + p[0] + (p[1] - 1) * eshift_[8]
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexEdgeEF(const SimplexId p[3],
                                                      const int id) const {
  switch(id) {
    case 0:
      return esetshift_[3] + p[0] + (p[1] - 1) * eshift_[8]
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexEdgeF(const SimplexId p[3],
                                                     const int id) const {
  switch(id) {
    case 0:
      return esetshift_[3] + p[0] + (p[1] - 1) * eshift_[8]
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexEdgeEG(const SimplexId p[3],
                                                      const int id) const {
  switch(id) {
    case 0:
      return esetshift_[3] + p[0] + (p[1] - 1) * eshift_[8]
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexEdgeEFHG(const SimplexId p[3],
                                                        const int id) const {
  switch(id) {
    case 0:
      return esetshift_[3] + p[0] + (p[1] - 1) * eshift_[8]
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexEdgeFH(const SimplexId p[3],
                                                      const int id) const {
  switch(id) {
    case 0:
      return esetshift_[3] + p[0] + (p[1] - 1) * eshift_[8]
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexEdgeG(const SimplexId p[3],
                                                     const int id) const {
  switch(id) {
    case 0:
      return esetshift_[3] + p[0] + (p[1] - 1) * eshift_[8]
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexEdgeGH(const SimplexId p[3],
                                                      const int id) const {
  switch(id) {
    case 0:
      return esetshift_[3] + p[0] + (p[1] - 1) * eshift_[8]
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexEdgeH(const SimplexId p[3],
                                                     const int id) const {
  switch(id) {
    case 0:
      return esetshift_[3] + p[0] + (p[1] - 1) * eshift_[8]
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexLinkA(const SimplexId p[3],
                                                     const int id) const {
  switch(id) {
    case 0:
    ...
    case 2:
      return tsetshift_[1] + (p[0] - 1) * 2 + p[1] * tshift_[4]
             + p[2] * tshift_[5] + 2 * wrap_[0];
    case 3:
      return tsetshift_[1] + (p[0] - 1) * 2 + p[1] * tshift_[4]
             + p[2] * tshift_[5] + 1 + 2 * wrap_[0];
    case 4:
      return tsetshift_[0] + (p[0] - 1) * 2 + (p[1] + 1) * tshift_[2]
             + p[2] * tshift_[3] + 2 * wrap_[0];
    case 5:
      return tsetshift_[0] + (p[0] - 1) * 2 + (p[1] + 1) * tshift_[2]
             + p[2] * tshift_[3] + 1 + 2 * wrap_[0];
    case 6:
    ...
    case 8:
      return tsetshift_[3] + p[0] * 2 + (p[1] - 1) * tshift_[8]
             + p[2] * tshift_[9] + 2 * wrap_[1];
    case 9:
      return tsetshift_[2] + p[0] * 2 + (p[1] - 1) * tshift_[6]
             + p[2] * tshift_[7] + 2 * wrap_[1];
    case 10:
      return tsetshift_[4] + (p[0] - 1) * 2 + (p[1] - 1) * tshift_[10]
             + p[2] * tshift_[11] + 2 * wrap_[0] + 2 * wrap_[1];
    case 11:
      return tsetshift_[3] + (p[0] - 1) * 2 + (p[1] - 1) * tshift_[8]
             + p[2] * tshift_[9] + 1 + 2 * wrap_[0] + 2 * wrap_[1];
    case 12:
      return tsetshift_[3] + p[0] * 2 + p[1] * tshift_[8]
             + (p[2] - 1) * tshift_[9] + 2 * wrap_[2];
    case 13:
      return tsetshift_[4] + p[0] * 2 + p[1] * tshift_[10]
             + (p[2] - 1) * tshift_[11] + 1 + 2 * wrap_[2];
    case 14:
      return tsetshift_[2] + (p[0] - 1) * 2 + p[1] * tshift_[6]
             + (p[2] - 1) * tshift_[7] + 1 + 2 * wrap_[0] + 2 * wrap_[2];
    case 15:
      return tsetshift_[3] + (p[0] - 1) * 2 + p[1] * tshift_[8]
             + (p[2] - 1) * tshift_[9] + 1 + 2 * wrap_[0] + 2 * wrap_[2];
    case 16:
      return tsetshift_[1] + (p[0] + 1) * 2 + (p[1] - 1) * tshift_[4]
             + (p[2] - 1) * tshift_[5] + 2 * wrap_[1] + 2 * wrap_[2];
    case 17:
      return tsetshift_[1] + (p[0] + 1) * 2 + (p[1] - 1) * tshift_[4]
             + (p[2] - 1) * tshift_[5] + 1 + 2 * wrap_[1] + 2 * wrap_[2];
    case 18:
      return tsetshift_[0] + p[0] * 2 + (p[1] - 1) * tshift_[2]
             + (p[2] - 1) * tshift_[3] + 2 * wrap_[1] + 2 * wrap_[2];
    case 19:
      return tsetshift_[0] + p[0] * 2 + (p[1] - 1) * tshift_[2]
             + (p[2] - 1) * tshift_[3] + 1 + 2 * wrap_[1] + 2 * wrap_[2];
    case 20:
    ...
    case 22:
      return tsetshift_[4] + (p[0] - 1) * 2 + (p[1] - 1) * tshift_[10]
             + (p[2] - 1) * tshift_[11] + 1 + 2 * wrap_[0] + 2 * wrap_[1]
             + 2 * wrap_[2];
    case 23:
      return tsetshift_[2] + (p[0] - 1) * 2 + (p[1] - 1) * tshift_[6]
             + (p[2] - 1) * tshift_[7] + 2 * wrap_[0] + 2 * wrap_[1]
             + 2 * wrap_[2];
  }
  return -1;
}
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexLinkAB(const SimplexId p[3],
                                                      const int id) const {
  switch(id) {
    case 0:
      return tsetshift_[4] + p[0] * 2 + p[1] * tshift_[10] + p[2] * tshift_[11];
    ...
    case 10:
      return tsetshift_[4] + (p[0] - 1) * 2 + (p[1] - 1) * tshift_[10]
             + p[2] * tshift_[11] + 2 * wrap_[1];
    case 11:
      return tsetshift_[3] + (p[0] - 1) * 2 + (p[1] - 1) * tshift_[8]
             + p[2] * tshift_[9] + 1 + 2 * wrap_[1];
    case 12:
      return tsetshift_[3] + p[0] * 2 + p[1] * tshift_[8]
             + (p[2] - 1) * tshift_[9] + 2 * wrap_[2];
    case 13:
    ...
    case 14:
      return tsetshift_[2] + (p[0] - 1) * 2 + p[1] * tshift_[6]
             + (p[2] - 1) * tshift_[7] + 1 + 2 * wrap_[2];
    case 15:
      return tsetshift_[3] + (p[0] - 1) * 2 + p[1] * tshift_[8]
             + (p[2] - 1) * tshift_[9] + 1 + 2 * wrap_[2];
    case 16:
      return tsetshift_[1] + (p[0] + 1) * 2 + (p[1] - 1) * tshift_[4]
             + (p[2] - 1) * tshift_[5] + 2 * wrap_[1] + 2 * wrap_[2];
    case 17:
    ...
    case 22:
      return tsetshift_[4] + (p[0] - 1) * 2 + (p[1] - 1) * tshift_[10]
             + (p[2] - 1) * tshift_[11] + 1 + 2 * wrap_[1] + 2 * wrap_[2];
    case 23:
      return tsetshift_[2] + (p[0] - 1) * 2 + (p[1] - 1) * tshift_[6]
             + (p[2] - 1) * tshift_[7] + 2 * wrap_[1] + 2 * wrap_[2];
  }
  return -1;
}

inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexLinkB(const SimplexId p[3],
                                                     const int id) const {
  switch(id) {
    case 0:
      return tsetshift_[4] + p[0] * 2 + p[1] * tshift_[10] + p[2] * tshift_[11];
    ...
    case 16:
      return tsetshift_[1] + (p[0] + 1) * 2 + (p[1] - 1) * tshift_[4]
             + (p[2] - 1) * tshift_[5] - 2 * wrap_[0] + 2 * wrap_[1]
             + 2 * wrap_[2];
    case 17:
      return tsetshift_[1] + (p[0] + 1) * 2 + (p[1] - 1) * tshift_[4]
             + (p[2] - 1) * tshift_[5] + 1 - 2 * wrap_[0] + 2 * wrap_[1]
             + 2 * wrap_[2];
    case 18:
      return tsetshift_[0] + p[0] * 2 + (p[1] - 1) * tshift_[2]
             + (p[2] - 1) * tshift_[3] + 2 * wrap_[1] + 2 * wrap_[2];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexLinkAC(const SimplexId p[3],
                                                      const int id) const {
  switch(id) {
    case 0:
      return tsetshift_[4] + p[0] * 2 + p[1] * tshift_[10] + p[2] * tshift_[11];
    ...
    case 10:
      return tsetshift_[4] + (p[0] - 1) * 2 + (p[1] - 1) * tshift_[10]
             + p[2] * tshift_[11] + 2 * wrap_[0];
    case 11:
      return tsetshift_[3] + (p[0] - 1) * 2 + (p[1] - 1) * tshift_[8]
             + p[2] * tshift_[9] + 1 + 2 * wrap_[0];
    case 12:
      return tsetshift_[3] + p[0] * 2 + p[1] * tshift_[8]
             + (p[2] - 1) * tshift_[9] + 2 * wrap_[2];
    case 13:
    ...
    case 16:
      return tsetshift_[1] + (p[0] + 1) * 2 + (p[1] - 1) * tshift_[4]
             + (p[2] - 1) * tshift_[5] + 2 * wrap_[2];
    case 17:
      return tsetshift_[1] + (p[0] + 1) * 2 + (p[1] - 1) * tshift_[4]
             + (p[2] - 1) * tshift_[5] + 1 + 2 * wrap_[2];
    case 18:
      return tsetshift_[0] + p[0] * 2 + (p[1] - 1) * tshift_[2]
             + (p[2] - 1) * tshift_[3] + 2 * wrap_[2];
    case 19:
      return tsetshift_[0] + p[0] * 2 + (p[1] - 1) * tshift_[2]
             + (p[2] - 1) * tshift_[3] + 1 + 2 * wrap_[2];
    case 20:
      return p[0] * 2 + (p[1] - 1) * tshift_[0] + (p[2] - 1) * tshift_[1]
             + 2 * wrap_[2];
    case 21:
    ...
    case 22:
      return tsetshift_[4] + (p[0] - 1) * 2 + (p[1] - 1) * tshift_[10]
             + (p[2] - 1) * tshift_[11] + 1 + 2 * wrap_[0] + 2 * wrap_[2];
    case 23:
      return tsetshift_[2] + (p[0] - 1) * 2 + (p[1] - 1) * tshift_[6]
             + (p[2] - 1) * tshift_[7] + 2 * wrap_[0] + 2 * wrap_[2];
  }
  return -1;
}

inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexLinkABDC(const SimplexId p[3],
                                                        const int id) const {
  switch(id) {
    case 0:
      return tsetshift_[4] + p[0] * 2 + p[1] * tshift_[10] + p[2] * tshift_[11];
    ...
    case 23:
      return tsetshift_[2] + (p[0] - 1) * 2 + (p[1] - 1) * tshift_[6]
             + (p[2] - 1) * tshift_[7] + 2 * wrap_[2];
  }
  return -1;
}

inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexLinkBD(const SimplexId p[3],
                                                      const int id) const {
  switch(id) {
    case 0:
      return tsetshift_[4] + p[0] * 2 + p[1] * tshift_[10] + p[2] * tshift_[11];
    ...
    case 16:
      return tsetshift_[1] + (p[0] + 1) * 2 + (p[1] - 1) * tshift_[4]
             + (p[2] - 1) * tshift_[5] - 2 * wrap_[0] + 2 * wrap_[2];
    case 17:
      return tsetshift_[1] + (p[0] + 1) * 2 + (p[1] - 1) * tshift_[4]
             + (p[2] - 1) * tshift_[5] + 1 - 2 * wrap_[0] + 2 * wrap_[2];
    case 18:
      return tsetshift_[0] + p[0] * 2 + (p[1] - 1) * tshift_[2]
             + (p[2] - 1) * tshift_[3] + 2 * wrap_[2];
    case 19:
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexLinkC(const SimplexId p[3],
                                                     const int id) const {
  switch(id) {
    case 0:
      return tsetshift_[4] + p[0] * 2 + p[1] * tshift_[10] + p[2] * tshift_[11];
    ...
    case 4:
      return tsetshift_[0] + (p[0] - 1) * 2 + (p[1] + 1) * tshift_[2]
             + p[2] * tshift_[3] + 2 * wrap_[0] - 2 * wrap_[1];
    case 5:
      return tsetshift_[0] + (p[0] - 1) * 2 + (p[1] + 1) * tshift_[2]
             + p[2] * tshift_[3] + 1 + 2 * wrap_[0] - 2 * wrap_[1];
    case 6:
      return (p[0] - 1) * 2 + p[1] * tshift_[0] + (p[2] + 1) * tshift_[1]
             + 2 * wrap_[0];
    case 7:
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexLinkCD(const SimplexId p[3],
                                                      const int id) const {
  switch(id) {
    case 0:
      return tsetshift_[4] + p[0] * 2 + p[1] * tshift_[10] + p[2] * tshift_[11];
    ...
    case 4:
      return tsetshift_[0] + (p[0] - 1) * 2 + (p[1] + 1) * tshift_[2]
             + p[2] * tshift_[3] - 2 * wrap_[1];
    case 5:
      return tsetshift_[0] + (p[0] - 1) * 2 + (p[1] + 1) * tshift_[2]
             + p[2] * tshift_[3] + 1 - 2 * wrap_[1];
    case 6:
      return (p[0] - 1) * 2 + p[1] * tshift_[0] + (p[2] + 1) * tshift_[1];
    case 7:
      return (p[0] - 1) * 2 + p[1] * tshift_[0] + (p[2] + 1) * tshift_[1] + 1;
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexLinkD(const SimplexId p[3],
                                                     const int id) const {
  switch(id) {
    case 0:
      return tsetshift_[4] + p[0] * 2 + p[1] * tshift_[10] + p[2] * tshift_[11];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexLinkAE(const SimplexId p[3],
                                                      const int id) const {
  switch(id) {
    case 0:
      return tsetshift_[4] + p[0] * 2 + p[1] * tshift_[10] + p[2] * tshift_[11];
    ...
    case 14:
      return tsetshift_[2] + (p[0] - 1) * 2 + p[1] * tshift_[6]
             + (p[2] - 1) * tshift_[7] + 1 + 2 * wrap_[0];
    case 15:
      return tsetshift_[3] + (p[0] - 1) * 2 + p[1] * tshift_[8]
             + (p[2] - 1) * tshift_[9] + 1 + 2 * wrap_[0];
    case 16:
      return tsetshift_[1] + (p[0] + 1) * 2 + (p[1] - 1) * tshift_[4]
             + (p[2] - 1) * tshift_[5] + 2 * wrap_[1];
    case 17:
      return tsetshift_[1] + (p[0] + 1) * 2 + (p[1] - 1) * tshift_[4]
             + (p[2] - 1) * tshift_[5] + 1 + 2 * wrap_[1];
    case 18:
      return tsetshift_[0] + p[0] * 2 + (p[1] - 1) * tshift_[2]
             + (p[2] - 1) * tshift_[3] + 2 * wrap_[1];
    case 19:
      return tsetshift_[0] + p[0] * 2 + (p[1] - 1) * tshift_[2]
             + (p[2] - 1) * tshift_[3] + 1 + 2 * wrap_[1];
    case 20:
      return p[0] * 2 + (p[1] - 1) * tshift_[0] + (p[2] - 1) * tshift_[1]
             + 2 * wrap_[1];
    case 21:
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexLinkAEFB(const SimplexId p[3],
                                                        const int id) const {
  switch(id) {
    case 0:
      return tsetshift_[4] + p[0] * 2 + p[1] * tshift_[10] + p[2] * tshift_[11];
    ...
    case 22:
      return tsetshift_[4] + (p[0] - 1) * 2 + (p[1] - 1) * tshift_[10]
             + (p[2] - 1) * tshift_[11] + 1 + 2 * wrap_[1];
    case 23:
      return tsetshift_[2] + (p[0] - 1) * 2 + (p[1] - 1) * tshift_[6]
             + (p[2] - 1) * tshift_[7] + 2 * wrap_[1];
  }
  return -1;
}

inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexLinkBF(const SimplexId p[3],
                                                      const int id) const {
  switch(id) {
    case 0:
      return tsetshift_[4] + p[0] * 2 + p[1] * tshift_[10] + p[2] * tshift_[11];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexLinkAEGC(const SimplexId p[3],
                                                        const int id) const {
  switch(id) {
    case 0:
      return tsetshift_[4] + p[0] * 2 + p[1] * tshift_[10] + p[2] * tshift_[11];
    ...
    case 22:
      return tsetshift_[4] + (p[0] - 1) * 2 + (p[1] - 1) * tshift_[10]
             + (p[2] - 1) * tshift_[11] + 1 + 2 * wrap_[0];
    case 23:
      return tsetshift_[2] + (p[0] - 1) * 2 + (p[1] - 1) * tshift_[6]
             + (p[2] - 1) * tshift_[7] + 2 * wrap_[0];
  }
  return -1;
}

inline ttk::SimplexId ttk::PeriodicImplicitTriangulation::getVertexLinkABCDEFGH(
  const SimplexId p[3], const int id) const {
  switch(id) {
    case 0:
      return tsetshift_[4] + p[0] * 2 + p[1] * tshift_[10] + p[2] * tshift_[11];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexLinkBFHD(const SimplexId p[3],
                                                        const int id) const {
  switch(id) {
    case 0:
      return tsetshift_[4] + p[0] * 2 + p[1] * tshift_[10] + p[2] * tshift_[11];
    ...
    case 16:
      return tsetshift_[1] + (p[0] + 1) * 2 + (p[1] - 1) * tshift_[4]
             + (p[2] - 1) * tshift_[5] - 2 * wrap_[0];
    case 17:
      return tsetshift_[1] + (p[0] + 1) * 2 + (p[1] - 1) * tshift_[4]
             + (p[2] - 1) * tshift_[5] + 1 - 2 * wrap_[0];
    case 18:
      return tsetshift_[0] + p[0] * 2 + (p[1] - 1) * tshift_[2]
             + (p[2] - 1) * tshift_[3];
    case 19:
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexLinkCG(const SimplexId p[3],
                                                      const int id) const {
  switch(id) {
    case 0:
      return tsetshift_[4] + p[0] * 2 + p[1] * tshift_[10] + p[2] * tshift_[11];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexLinkGHDC(const SimplexId p[3],
                                                        const int id) const {
  switch(id) {
    case 0:
      return tsetshift_[4] + p[0] * 2 + p[1] * tshift_[10] + p[2] * tshift_[11];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexLinkDH(const SimplexId p[3],
                                                      const int id) const {
  switch(id) {
    case 0:
      return tsetshift_[4] + p[0] * 2 + p[1] * tshift_[10] + p[2] * tshift_[11];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexLinkE(const SimplexId p[3],
                                                     const int id) const {
  switch(id) {
    case 0:
      return tsetshift_[4] + p[0] * 2 + p[1] * tshift_[10] + p[2] * tshift_[11];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexLinkEF(const SimplexId p[3],
                                                      const int id) const {
  switch(id) {
    case 0:
      return tsetshift_[4] + p[0] * 2 + p[1] * tshift_[10] + p[2] * tshift_[11];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexLinkF(const SimplexId p[3],
                                                     const int id) const {
  switch(id) {
    case 0:
      return tsetshift_[4] + p[0] * 2 + p[1] * tshift_[10] + p[2] * tshift_[11];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexLinkEG(const SimplexId p[3],
                                                      const int id) const {
  switch(id) {
    case 0:
      return tsetshift_[4] + p[0] * 2 + p[1] * tshift_[10] + p[2] * tshift_[11];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexLinkEFHG(const SimplexId p[3],
                                                        const int id) const {
  switch(id) {
    case 0:
      return tsetshift_[4] + p[0] * 2 + p[1] * tshift_[10] + p[2] * tshift_[11];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexLinkFH(const SimplexId p[3],
                                                      const int id) const {
  switch(id) {
    case 0:
      return tsetshift_[4] + p[0] * 2 + p[1] * tshift_[10] + p[2] * tshift_[11];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexLinkG(const SimplexId p[3],
                                                     const int id) const {
  switch(id) {
    case 0:
      return tsetshift_[4] + p[0] * 2 + p[1] * tshift_[10] + p[2] * tshift_[11];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexLinkGH(const SimplexId p[3],
                                                      const int id) const {
  switch(id) {
    case 0:
      return tsetshift_[4] + p[0] * 2 + p[1] * tshift_[10] + p[2] * tshift_[11];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexLinkH(const SimplexId p[3],
                                                     const int id) const {
  switch(id) {
    case 0:
      return tsetshift_[4] + p[0] * 2 + p[1] * tshift_[10] + p[2] * tshift_[11];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexTriangleA(const SimplexId p[3],
                                                         const int id) const {
  switch(id) {
    case 0:
    ...
    case 6:
      return tsetshift_[4] + (p[0] - 1) * 2 + p[1] * tshift_[10]
             + p[2] * tshift_[11] + 1 + 2 * wrap_[0];
    case 7:
      return tsetshift_[0] + (p[0] - 1) * 2 + p[1] * tshift_[2]
             + p[2] * tshift_[3] + 1 + 2 * wrap_[0];
    case 8:
      return tsetshift_[2] + (p[0] - 1) * 2 + p[1] * tshift_[6]
             + p[2] * tshift_[7] + 1 + 2 * wrap_[0];
    case 9:
      return tsetshift_[3] + (p[0] - 1) * 2 + p[1] * tshift_[8]
             + p[2] * tshift_[9] + 2 * wrap_[0];
    case 10:
      return tsetshift_[0] + (p[0] - 1) * 2 + p[1] * tshift_[2]
             + p[2] * tshift_[3] + 2 * wrap_[0];
    case 11:
    ...
    case 13:
      return p[0] * 2 + tsetshift_[2] + (p[1] - 1) * tshift_[6]
             + (p[2] - 1) * tshift_[7] + 1 + 2 * wrap_[1] + 2 * wrap_[2];
    case 14:
    ...
    case 16:
      return p[0] * 2 + tsetshift_[3] + (p[1] - 1) * tshift_[8]
             + (p[2] - 1) * tshift_[9] + 2 * wrap_[1] + 2 * wrap_[2];
    case 17:
      return p[0] * 2 + tsetshift_[3] + (p[1] - 1) * tshift_[8]
             + (p[2] - 1) * tshift_[9] + 1 + 2 * wrap_[1] + 2 * wrap_[2];
    case 18:
      return p[0] * 2 + tsetshift_[4] + (p[1] - 1) * tshift_[10]
             + (p[2] - 1) * tshift_[11] + 2 * wrap_[1] + 2 * wrap_[2];
    case 19:
      return p[0] * 2 + tsetshift_[4] + (p[1] - 1) * tshift_[10]
             + (p[2] - 1) * tshift_[11] + 1 + 2 * wrap_[1] + 2 * wrap_[2];
    case 20:
    ...
    case 25:
      return tsetshift_[2] + (p[0] - 1) * 2 + (p[1] - 1) * tshift_[6]
             + p[2] * tshift_[7] + 2 * wrap_[0] + 2 * wrap_[1];
    case 26:
      return tsetshift_[1] + p[0] * 2 + (p[1] - 1) * tshift_[4]
             + p[2] * tshift_[5] + 2 * wrap_[1];
    case 27:
    ...
    case 31:
      return tsetshift_[0] + (p[0] - 1) * 2 + p[1] * tshift_[2]
             + (p[2] - 1) * tshift_[3] + 1 + 2 * wrap_[0] + 2 * wrap_[1]
             + 2 * wrap_[2];
    case 32:
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexTriangleAB(const SimplexId p[3],
                                                          const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 2 + p[1] * tshift_[0] + p[2] * tshift_[1] + 1;
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexTriangleB(const SimplexId p[3],
                                                         const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 2 + p[1] * tshift_[0] + p[2] * tshift_[1] + 1;
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexTriangleAC(const SimplexId p[3],
                                                          const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 2 + p[1] * tshift_[0] + p[2] * tshift_[1] + 1
    ...
    case 31:
      return tsetshift_[0] + (p[0] - 1) * 2 + p[1] * tshift_[2]
             + (p[2] - 1) * tshift_[3] + 1 + 2 * wrap_[0] + 2 * wrap_[2];
    case 32:
      return tsetshift_[0] + p[0] * 2 + p[1] * tshift_[2] + p[2] * tshift_[3];
    case 33:
      return tsetshift_[3] + p[0] * 2 + p[1] * tshift_[8] + p[2] * tshift_[9];
...
inline ttk::SimplexId ttk::PeriodicImplicitTriangulation::getVertexTriangleABDC(
  const SimplexId p[3], const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 2 + p[1] * tshift_[0] + p[2] * tshift_[1] + 1;
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexTriangleBD(const SimplexId p[3],
                                                          const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 2 + p[1] * tshift_[0] + p[2] * tshift_[1] + 1;
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexTriangleC(const SimplexId p[3],
                                                         const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 2 + p[1] * tshift_[0] + p[2] * tshift_[1] + 1
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexTriangleCD(const SimplexId p[3],
                                                          const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 2 + p[1] * tshift_[0] + p[2] * tshift_[1] + 1;
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexTriangleD(const SimplexId p[3],
                                                         const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 2 + p[1] * tshift_[0] + p[2] * tshift_[1] + 1;
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexTriangleAE(const SimplexId p[3],
                                                          const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 2 + p[1] * tshift_[0] + p[2] * tshift_[1] + 1
    ...
    case 16:
      return p[0] * 2 + tsetshift_[3] + (p[1] - 1) * tshift_[8]
             + (p[2] - 1) * tshift_[9] + 2 * wrap_[1];
    case 17:
      return p[0] * 2 + tsetshift_[3] + (p[1] - 1) * tshift_[8]
             + (p[2] - 1) * tshift_[9] + 1 + 2 * wrap_[1];
    case 18:
      return p[0] * 2 + tsetshift_[4] + (p[1] - 1) * tshift_[10]
             + (p[2] - 1) * tshift_[11] + 2 * wrap_[1];
    case 19:
      return p[0] * 2 + tsetshift_[4] + (p[1] - 1) * tshift_[10]
             + (p[2] - 1) * tshift_[11] + 1 + 2 * wrap_[1];
    case 20:
...
inline ttk::SimplexId ttk::PeriodicImplicitTriangulation::getVertexTriangleAEFB(
  const SimplexId p[3], const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 2 + p[1] * tshift_[0] + p[2] * tshift_[1] + 1;
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexTriangleBF(const SimplexId p[3],
                                                          const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 2 + p[1] * tshift_[0] + p[2] * tshift_[1] + 1;
...
inline ttk::SimplexId ttk::PeriodicImplicitTriangulation::getVertexTriangleAEGC(
  const SimplexId p[3], const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 2 + p[1] * tshift_[0] + p[2] * tshift_[1] + 1
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexTriangleABCDEFGH(
    const SimplexId p[3], const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 2 + p[1] * tshift_[0] + p[2] * tshift_[1] + 1;
...
inline ttk::SimplexId ttk::PeriodicImplicitTriangulation::getVertexTriangleBFHD(
  const SimplexId p[3], const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 2 + p[1] * tshift_[0] + p[2] * tshift_[1] + 1;
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexTriangleCG(const SimplexId p[3],
                                                          const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 2 + p[1] * tshift_[0] + p[2] * tshift_[1] + 1
...
inline ttk::SimplexId ttk::PeriodicImplicitTriangulation::getVertexTriangleGHDC(
  const SimplexId p[3], const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 2 + p[1] * tshift_[0] + p[2] * tshift_[1] + 1;
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexTriangleDH(const SimplexId p[3],
                                                          const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 2 + p[1] * tshift_[0] + p[2] * tshift_[1] + 1;
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexTriangleE(const SimplexId p[3],
                                                         const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 2 + p[1] * tshift_[0] + p[2] * tshift_[1] + 1
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexTriangleEF(const SimplexId p[3],
                                                          const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 2 + p[1] * tshift_[0] + p[2] * tshift_[1] + 1;
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexTriangleF(const SimplexId p[3],
                                                         const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 2 + p[1] * tshift_[0] + p[2] * tshift_[1] + 1;
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexTriangleEG(const SimplexId p[3],
                                                          const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 2 + p[1] * tshift_[0] + p[2] * tshift_[1] + 1
...
inline ttk::SimplexId ttk::PeriodicImplicitTriangulation::getVertexTriangleEFHG(
  const SimplexId p[3], const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 2 + p[1] * tshift_[0] + p[2] * tshift_[1] + 1;
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexTriangleFH(const SimplexId p[3],
                                                          const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 2 + p[1] * tshift_[0] + p[2] * tshift_[1] + 1;
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexTriangleG(const SimplexId p[3],
                                                         const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 2 + p[1] * tshift_[0] + p[2] * tshift_[1] + 1
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexTriangleGH(const SimplexId p[3],
                                                          const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 2 + p[1] * tshift_[0] + p[2] * tshift_[1] + 1;
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexTriangleH(const SimplexId p[3],
                                                         const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 2 + p[1] * tshift_[0] + p[2] * tshift_[1] + 1;
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexStarA(const SimplexId p[3],
                                                     const int id) const {
  switch(id) {
    case 0:
    ...
    case 7:
      return p[0] * 6 + (p[1] - 1) * tetshift_[0] + (p[2] - 1) * tetshift_[1]
             + 1 + 6 * wrap_[1] + 6 * wrap_[2];
    case 8:
      return p[0] * 6 + (p[1] - 1) * tetshift_[0] + (p[2] - 1) * tetshift_[1]
             + 2 + 6 * wrap_[1] + 6 * wrap_[2];
    case 9:
      return p[0] * 6 + (p[1] - 1) * tetshift_[0] + (p[2] - 1) * tetshift_[1]
             + 3 + 6 * wrap_[1] + 6 * wrap_[2];
    case 10:
      return p[0] * 6 + (p[1] - 1) * tetshift_[0] + (p[2] - 1) * tetshift_[1]
             + 4 + 6 * wrap_[1] + 6 * wrap_[2];
    case 11:
      return p[0] * 6 + (p[1] - 1) * tetshift_[0] + (p[2] - 1) * tetshift_[1]
             + 5 + 6 * wrap_[1] + 6 * wrap_[2];
    case 12:
    ...
    case 16:
      return (p[0] - 1) * 6 + (p[1] - 1) * tetshift_[0] + p[2] * tetshift_[1]
             + 1 + 6 * wrap_[0] + 6 * wrap_[1];
    case 17:
      return (p[0] - 1) * 6 + (p[1] - 1) * tetshift_[0] + p[2] * tetshift_[1]
             + 5 + 6 * wrap_[0] + 6 * wrap_[1];
    case 18:
    ...
    case 20:
      return (p[0] - 1) * 6 + p[1] * tetshift_[0] + (p[2] - 1) * tetshift_[1]
             + 3 + 6 * wrap_[0] + 6 * wrap_[2];
    case 21:
      return (p[0] - 1) * 6 + p[1] * tetshift_[0] + (p[2] - 1) * tetshift_[1]
             + 4 + 6 * wrap_[0] + 6 * wrap_[2];
    case 22:
      return (p[0] - 1) * 6 + (p[1] - 1) * tetshift_[0]
             + (p[2] - 1) * tetshift_[1] + 4 + 6 * wrap_[0] + 6 * wrap_[1]
             + 6 * wrap_[2];
    case 23:
      return (p[0] - 1) * 6 + (p[1] - 1) * tetshift_[0]
             + (p[2] - 1) * tetshift_[1] + 5 + 6 * wrap_[0] + 6 * wrap_[1]
             + 6 * wrap_[2];
  }
  return -1;
}
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexStarAB(const SimplexId p[3],
                                                      const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 6 + p[1] * tetshift_[0] + p[2] * tetshift_[1];
    ...
    case 22:
      return (p[0] - 1) * 6 + (p[1] - 1) * tetshift_[0]
             + (p[2] - 1) * tetshift_[1] + 4 + 6 * wrap_[1] + 6 * wrap_[2];
    case 23:
      return (p[0] - 1) * 6 + (p[1] - 1) * tetshift_[0]
             + (p[2] - 1) * tetshift_[1] + 5 + 6 * wrap_[1] + 6 * wrap_[2];
  }
  return -1;
}

inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexStarB(const SimplexId p[3],
                                                     const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 6 + p[1] * tetshift_[0] + p[2] * tetshift_[1];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexStarAC(const SimplexId p[3],
                                                      const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 6 + p[1] * tetshift_[0] + p[2] * tetshift_[1]
    ...
    case 22:
      return (p[0] - 1) * 6 + (p[1] - 1) * tetshift_[0]
             + (p[2] - 1) * tetshift_[1] + 4 + 6 * wrap_[0] + 6 * wrap_[2];
    case 23:
      return (p[0] - 1) * 6 + (p[1] - 1) * tetshift_[0]
             + (p[2] - 1) * tetshift_[1] + 5 + 6 * wrap_[0] + 6 * wrap_[2];
  }
  return -1;
}

inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexStarABDC(const SimplexId p[3],
                                                        const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 6 + p[1] * tetshift_[0] + p[2] * tetshift_[1];
    ...
    case 22:
      return (p[0] - 1) * 6 + (p[1] - 1) * tetshift_[0]
             + (p[2] - 1) * tetshift_[1] + 4 + 6 * wrap_[2];
    case 23:
      return (p[0] - 1) * 6 + (p[1] - 1) * tetshift_[0]
             + (p[2] - 1) * tetshift_[1] + 5 + 6 * wrap_[2];
  }
  return -1;
}

inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexStarBD(const SimplexId p[3],
                                                      const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 6 + p[1] * tetshift_[0] + p[2] * tetshift_[1];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexStarC(const SimplexId p[3],
                                                     const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 6 + p[1] * tetshift_[0] + p[2] * tetshift_[1]
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexStarCD(const SimplexId p[3],
                                                      const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 6 + p[1] * tetshift_[0] + p[2] * tetshift_[1];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexStarD(const SimplexId p[3],
                                                     const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 6 + p[1] * tetshift_[0] + p[2] * tetshift_[1];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexStarAE(const SimplexId p[3],
                                                      const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 6 + p[1] * tetshift_[0] + p[2] * tetshift_[1]
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexStarAEFB(const SimplexId p[3],
                                                        const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 6 + p[1] * tetshift_[0] + p[2] * tetshift_[1];
    ...
    case 22:
      return (p[0] - 1) * 6 + (p[1] - 1) * tetshift_[0]
             + (p[2] - 1) * tetshift_[1] + 4 + 6 * wrap_[1];
    case 23:
      return (p[0] - 1) * 6 + (p[1] - 1) * tetshift_[0]
             + (p[2] - 1) * tetshift_[1] + 5 + 6 * wrap_[1];
  }
  return -1;
}

inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexStarBF(const SimplexId p[3],
                                                      const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 6 + p[1] * tetshift_[0] + p[2] * tetshift_[1];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexStarAEGC(const SimplexId p[3],
                                                        const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 6 + p[1] * tetshift_[0] + p[2] * tetshift_[1]
    ...
    case 22:
      return (p[0] - 1) * 6 + (p[1] - 1) * tetshift_[0]
             + (p[2] - 1) * tetshift_[1] + 4 + 6 * wrap_[0];
    case 23:
      return (p[0] - 1) * 6 + (p[1] - 1) * tetshift_[0]
             + (p[2] - 1) * tetshift_[1] + 5 + 6 * wrap_[0];
  }
  return -1;
}

inline ttk::SimplexId ttk::PeriodicImplicitTriangulation::getVertexStarABCDEFGH(
  const SimplexId p[3], const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 6 + p[1] * tetshift_[0] + p[2] * tetshift_[1];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexStarBFHD(const SimplexId p[3],
                                                        const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 6 + p[1] * tetshift_[0] + p[2] * tetshift_[1];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexStarCG(const SimplexId p[3],
                                                      const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 6 + p[1] * tetshift_[0] + p[2] * tetshift_[1]
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexStarGHDC(const SimplexId p[3],
                                                        const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 6 + p[1] * tetshift_[0] + p[2] * tetshift_[1];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexStarDH(const SimplexId p[3],
                                                      const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 6 + p[1] * tetshift_[0] + p[2] * tetshift_[1];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexStarE(const SimplexId p[3],
                                                     const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 6 + p[1] * tetshift_[0] + p[2] * tetshift_[1]
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexStarEF(const SimplexId p[3],
                                                      const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 6 + p[1] * tetshift_[0] + p[2] * tetshift_[1];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexStarF(const SimplexId p[3],
                                                     const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 6 + p[1] * tetshift_[0] + p[2] * tetshift_[1];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexStarEG(const SimplexId p[3],
                                                      const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 6 + p[1] * tetshift_[0] + p[2] * tetshift_[1]
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexStarEFHG(const SimplexId p[3],
                                                        const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 6 + p[1] * tetshift_[0] + p[2] * tetshift_[1];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexStarFH(const SimplexId p[3],
                                                      const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 6 + p[1] * tetshift_[0] + p[2] * tetshift_[1];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexStarG(const SimplexId p[3],
                                                     const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 6 + p[1] * tetshift_[0] + p[2] * tetshift_[1]
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexStarGH(const SimplexId p[3],
                                                      const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 6 + p[1] * tetshift_[0] + p[2] * tetshift_[1];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getVertexStarH(const SimplexId p[3],
                                                     const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 6 + p[1] * tetshift_[0] + p[2] * tetshift_[1];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getEdgeTriangleL_x00(const SimplexId p[3],
                                                           const int id) const {
  switch(id) {
    case 0:
      return p[0] * 2 + (p[1] - 1) * tshift_[0] + p[2] * tshift_[1] + 1
    ...
    case 2:
      return tsetshift_[0] + p[0] * 2 + p[1] * tshift_[2]
             + (p[2] - 1) * tshift_[3] + 1 + wrap_[2] * 2;
    case 3:
      return tsetshift_[3] + p[0] * 2 + (p[1] - 1) * tshift_[8]
             + (p[2] - 1) * tshift_[9] + 1 + wrap_[1] * 2 + wrap_[2] * 2;
    case 4:
      return p[0] * 2 + p[1] * tshift_[0] + p[2] * tshift_[1];
    case 5:
      return tsetshift_[3] + p[0] * 2 + p[1] * tshift_[8] + p[2] * tshift_[9];
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getEdgeTriangleL_xn0(const SimplexId p[3],
                                                           const int id) const {
  switch(id) {
    case 0:
      return p[0] * 2 + (p[1] - 1) * tshift_[0] + p[2] * tshift_[1] + 1;
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getEdgeTriangleL_x0n(const SimplexId p[3],
                                                           const int id) const {
  switch(id) {
    case 0:
      return p[0] * 2 + (p[1] - 1) * tshift_[0] + p[2] * tshift_[1] + 1
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getEdgeTriangleL_xnn(const SimplexId p[3],
                                                           const int id) const {
  switch(id) {
    case 0:
      return p[0] * 2 + (p[1] - 1) * tshift_[0] + p[2] * tshift_[1] + 1;
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getEdgeTriangleH_0y0(const SimplexId p[3],
                                                           const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 2 + p[1] * tshift_[0] + p[2] * tshift_[1] + 1
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getEdgeTriangleH_ny0(const SimplexId p[3],
                                                           const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 2 + p[1] * tshift_[0] + p[2] * tshift_[1] + 1;
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getEdgeTriangleH_0yn(const SimplexId p[3],
                                                           const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 2 + p[1] * tshift_[0] + p[2] * tshift_[1] + 1
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getEdgeTriangleH_nyn(const SimplexId p[3],
                                                           const int id) const {
  switch(id) {
    case 0:
      return (p[0] - 1) * 2 + p[1] * tshift_[0] + p[2] * tshift_[1] + 1;
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getEdgeTriangleP_00z(const SimplexId p[3],
                                                           const int id) const {
  switch(id) {
    case 0:
      return tsetshift_[0] + (p[0] - 1) * 2 + p[1] * tshift_[2]
             + p[2] * tshift_[3] + 1 + wrap_[0] * 2;
    case 1:
      return tsetshift_[4] + (p[0] - 1) * 2 + p[1] * tshift_[10]
             + p[2] * tshift_[11] + 1 + wrap_[0] * 2;
    case 2:
      return tsetshift_[1] + p[0] * 2 + p[1] * tshift_[4] + p[2] * tshift_[5]
             + 1;
    case 3:
    ...
    case 4:
      return tsetshift_[4] + p[0] * 2 + (p[1] - 1) * tshift_[10]
             + p[2] * tshift_[11] + wrap_[1] * 2;
    case 5:
      return tsetshift_[1] + p[0] * 2 + (p[1] - 1) * tshift_[4]
             + p[2] * tshift_[5] + wrap_[1] * 2;
  }
  return -1;
}

inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getEdgeTriangleP_n0z(const SimplexId p[3],
                                                           const int id) const {
  switch(id) {
    case 0:
      return tsetshift_[0] + (p[0] - 1) * 2 + p[1] * tshift_[2]
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getEdgeTriangleP_0nz(const SimplexId p[3],
                                                           const int id) const {
  switch(id) {
    case 0:
      return tsetshift_[0] + (p[0] - 1) * 2 + p[1] * tshift_[2]
...
inline ttk::SimplexId
  ttk::PeriodicImplicitTriangulation::getEdgeTriangleP_nnz(const SimplexId p[3],
                                                           const int id) const {
  switch(id) {
    case 0:
      return tsetshift_[0] + (p[0] - 1) * 2 + p[1] * tshift_[2]
...
inline ttk::SimplexId ttk::PeriodicImplicitTriangulation::getEdgeTriangleD1_xy0(
  const SimplexId p[3], const int id) const {
  switch(id) {
    case 0:
      return p[0] * 2 + p[1] * tshift_[0] + p[2] * tshift_[1];
    ...
    case 3:
      return tsetshift_[4] + p[0] * 2 + p[1] * tshift_[10]
             + (p[2] - 1) * tshift_[11] + 1 + wrap_[2] * 2;
  }
  return -1;
}

inline ttk::SimplexId ttk::PeriodicImplicitTriangulation::getEdgeTriangleD1_xyn(
  const SimplexId p[3], const int id) const {
  switch(id) {
    case 0:
      return p[0] * 2 + p[1] * tshift_[0] + p[2] * tshift_[1];
...
inline ttk::SimplexId ttk::PeriodicImplicitTriangulation::getEdgeTriangleD2_0yz(
  const SimplexId p[3], const int id) const {
  switch(id) {
    case 0:
      return tsetshift_[1] + p[0] * 2 + p[1] * tshift_[4] + p[2] * tshift_[5];
    ...
    case 3:
      return tsetshift_[3] + (p[0] - 1) * 2 + p[1] * tshift_[8]
             + p[2] * tshift_[9] + 1 + wrap_[0] * 2;
  }
  return -1;
}

inline ttk::SimplexId ttk::PeriodicImplicitTriangulation::getEdgeTriangleD2_nyz(
  const SimplexId p[3], const int id) const {
  switch(id) {
    case 0:
      return tsetshift_[1] + p[0] * 2 + p[1] * tshift_[4] + p[2] * tshift_[5];
...
inline ttk::SimplexId ttk::PeriodicImplicitTriangulation::getEdgeTriangleD3_x0z(
  const SimplexId p[3], const int id) const {
  switch(id) {
    case 0:
      return tsetshift_[0] + p[0] * 2 + p[1] * tshift_[2] + p[2] * tshift_[3];
    ...
    case 3:
      return tsetshift_[2] + p[0] * 2 + (p[1] - 1) * tshift_[6]
             + p[2] * tshift_[7] + wrap_[1] * 2;
  }
  return -1;
}

inline ttk::SimplexId ttk::PeriodicImplicitTriangulation::getEdgeTriangleD3_xnz(
  const SimplexId p[3], const int id) const {
  switch(id) {
    case 0:
      return tsetshift_[0] + p[0] * 2 + p[1] * tshift_[2] + p[2] * tshift_[3];
...
inline ttk::SimplexId ttk::PeriodicImplicitTriangulation::getEdgeTriangleD4_xyz(
  const SimplexId p[3], const int id) const {
  switch(id) {
    case 0:
      return tsetshift_[2] + p[0] * 2 + p[1] * tshift_[6] + p[2] * tshift_[7];
