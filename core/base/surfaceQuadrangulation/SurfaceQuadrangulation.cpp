...
ttk::SolvingMethodType ttk::SurfaceQuadrangulation::findBestSolver() const {
...
int ttk::SurfaceQuadrangulation::execute() const {
  ...
  {
    stringstream msg;
    msg << "[SurfaceQuadrangulation] Beginnning computation" << endl;
...

  {
    ...
    switch(info) {
      case Eigen::ComputationInfo::Success:
        msg << "[SurfaceQuadrangulation] Success!" << endl;
        break;
      case Eigen::ComputationInfo::NumericalIssue:
        msg << "[SurfaceQuadrangulation] Numerical Issue!" << endl;
        break;
      case Eigen::ComputationInfo::NoConvergence:
        msg << "[SurfaceQuadrangulation] No Convergence!" << endl;
        break;
      case Eigen::ComputationInfo::InvalidInput:
        msg << "[SurfaceQuadrangulation] Invalid Input!" << endl;
        break;
    }
    dMsg(cout, msg.str(), advancedInfoMsg);
  }
...
template int ttk::SurfaceQuadrangulation::execute<double>() const;
template int ttk::SurfaceQuadrangulation::execute<float>() const;
