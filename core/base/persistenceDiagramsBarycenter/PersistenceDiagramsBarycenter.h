...
/// \date The Date Here.
///
/// \brief TTK %persistenceDiagramsBarycenter processing package.
///
/// %PersistenceDiagramsBarycenter is a TTK processing package that takes a scalar field on the input 
...
namespace ttk{
  ...
  class PersistenceDiagramsBarycenter : public Debug{
    ...
    public:
      ...
      /// see the setInput*() functions of ttk::Triangulation). See ttkPersistenceDiagramsBarycenter 
...
// template functions
template <class dataType> int ttk::PersistenceDiagramsBarycenter::execute(
...
#pragma omp parallel for num_threads(threadNumber_) 
   ...
   
  {
    ...
    msg << "[PersistenceDiagramsBarycenter] Data-set (" << vertexNumber
      << " points) processed in "
