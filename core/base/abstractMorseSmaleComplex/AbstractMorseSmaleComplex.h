  ...
  public:
    ...
    inline int execute(const triangulationType &triangulation) {
      switch(triangulation.getDimensionality()) {
        ...
        case 3:
          return this->execute3D(triangulation);
      }
      return 0;
    }
...
template <typename triangulationType>
int ttk::AbstractMorseSmaleComplex::execute2D(
...
template <typename triangulationType>
int ttk::AbstractMorseSmaleComplex::execute3D(
  const triangulationType &triangulation) {
#ifndef TTK_ENABLE_KAMIKAZE
  if(!inputScalarField_) {
    this->printErr("Input scalar field pointer is null.");
...
template <typename triangulationType>
int ttk::AbstractMorseSmaleComplex::getSaddleConnectors(
  const std::vector<Cell> &criticalPoints,
  std::vector<Separatrix> &separatrices,
  std::vector<std::vector<Cell>> &separatricesGeometry,
  const triangulationType &triangulation) const {
...
template <typename triangulationType>
int ttk::AbstractMorseSmaleComplex::getAscendingSeparatrices2(
  const std::vector<Cell> &criticalPoints,
  std::vector<Separatrix> &separatrices,
  std::vector<std::vector<Cell>> &separatricesGeometry,
  std::vector<std::set<SimplexId>> &separatricesSaddles,
...
template <typename triangulationType>
int ttk::AbstractMorseSmaleComplex::getDescendingSeparatrices2(
  const std::vector<Cell> &criticalPoints,
  std::vector<Separatrix> &separatrices,
  std::vector<std::vector<Cell>> &separatricesGeometry,
  std::vector<std::set<SimplexId>> &separatricesSaddles,
...
template <typename triangulationType>
int ttk::AbstractMorseSmaleComplex::getDualPolygon(
...
template <typename triangulationType>
int ttk::AbstractMorseSmaleComplex::sortDualPolygonVertices(
  SimplexId *const polygon,
  const size_t polSize,
  const triangulationType &triangulation) const {
...
template <typename triangulationType>
int ttk::AbstractMorseSmaleComplex::setAscendingSeparatrices2(
  const std::vector<Separatrix> &separatrices,
  const std::vector<std::vector<dcg::Cell>> &separatricesGeometry,
  const std::vector<std::set<SimplexId>> &separatricesSaddles,
  const triangulationType &triangulation) const {
...
template <typename triangulationType>
int ttk::AbstractMorseSmaleComplex::setDescendingSeparatrices2(
  const std::vector<Separatrix> &separatrices,
  const std::vector<std::vector<dcg::Cell>> &separatricesGeometry,
  const std::vector<std::set<SimplexId>> &separatricesSaddles,
  const triangulationType &triangulation) const {
