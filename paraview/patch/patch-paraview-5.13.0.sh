...
$PATCH_BIN CMake/ParaViewOptions.cmake < "${PATCH_DIR}/paraview-5.13.0-ParaViewOptions.cmake.patch"
$PATCH_BIN CMakeLists.txt < "${PATCH_DIR}/paraview-5.13.0-CMakeLists.txt.patch"
## CPack variables for packaging meta-data
$PATCH_BIN CMakeLists.txt < "${PATCH_DIR}/paraview-5.13.0-CPack.patch"
