...
int main(int argc, char **argv) {
  ...
  //   program.parser_.setArgument("I", &iterationNumber, "Iteration number",
  //   true); program.parser_.setArgument(
  ...
  //     return ret;
  //
  //   // change here the arguments of the vtkWrapper that you want to update
  //   prior
  //   // to execution.
