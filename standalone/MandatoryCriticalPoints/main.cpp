...
/// \date February 2017.
///
/// \brief Command line program for MandatoryCriticalPoints computation.
...
int main(int argc, char **argv) {
  ...
  ttk::Debug msg;
  msg.setDebugMsgPrefix("MandatoryCriticalPoints");

  vtkNew<ttkMandatoryCriticalPoints> mcp{};
  ...
  for(size_t i = 0; i < inputFilePaths.size(); i++) {
    ...
    if(listArrays) {
      ...
      mcp->SetInputDataObject(i, reader->GetOutput());
