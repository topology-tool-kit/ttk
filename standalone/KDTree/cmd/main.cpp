...
int main(int argc, char **argv) {
	...
	std::cout<<"		"<< kdt.left_->id_<< "		"<< kdt.right_->id_<<std::endl;
	std::cout<<"	   "<< kdt.left_->left_->id_<<"	   "<< kdt.left_->right_->id_<< "	   "<< kdt.right_->left_->id_<< "	   "<< kdt.right_->right_->id_ << std::endl;
	
	KDTree<float> A, B, C, D, E, F, G;
	A = kdt;
	F = *(A.left_);     C = *(A.right_); 
	E = *(F.right_);    G = *(F.left_); 
	B = *(C.right_);    D = *(C.left_);
	
	std::cout<< A.coords_min_[0]<< ", " << A.coordinates_[0]<< ", " << A.coords_max_[0]<< std::endl;
	std::cout<< B.coords_min_[0]<< ", " << B.coordinates_[0]<< ", " << B.coords_max_[0]<< std::endl;
	std::cout<< C.coords_min_[0]<< ", " << C.coordinates_[0]<< ", " << C.coords_max_[0]<< std::endl;
	std::cout<< D.coords_min_[0]<< ", " << D.coordinates_[0]<< ", " << D.coords_max_[0]<< std::endl;
	std::cout<< E.coords_min_[0]<< ", " << E.coordinates_[0]<< ", " << E.coords_max_[0]<< std::endl;
	std::cout<< F.coords_min_[0]<< ", " << F.coordinates_[0]<< ", " << F.coords_max_[0]<< std::endl;
	std::cout<< G.coords_min_[0]<< ", " << G.coordinates_[0]<< ", " << G.coords_max_[0]<< std::endl;
